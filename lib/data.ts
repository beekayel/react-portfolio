...
export const experiencesData = [
  {
    title: "Senior SEO & SEM Manager - Droppe",
    location: "Helsinki, Finland (Remote)",
    description:
      "Increased organic traffic by 50% month-over-month through strategic content scaling and on-page optimization. Led SEO roadmap across metadata, structured data, and product listings, boosting CTR and conversion rates. Designed and deployed a backlink strategy to strengthen domain authority. Built an end-to-end SEM tool improving budget efficiency by 60%. Collaborated with product and dev teams to enhance crawlability, UX, and eCommerce performance.",
